...
export function TaskItem({
  ...
  return (
    <motion.li
      ...
      className={cn(
        "flex items-center justify-between gap-4 py-3 px-4 rounded-xl border transition-all duration-500 group/task relative overflow-hidden",
        isRunning
    ...
    >
      <div className="flex items-center gap-3 min-w-0 flex-1 relative z-10">
        <div className={cn(
          ...
          isRunning ? "bg-primary animate-pulse scale-125 shadow-[0_0_8px_oklch(var(--primary))]" : "bg-muted-foreground/30"
        )} />
        ...
        {isEditing ? (
          <div className="flex items-center gap-1 flex-1 min-w-0">
            ...
            />
            <Button size="icon" variant="ghost" className="h-8 w-8 text-primary" onClick={handleUpdateName}>
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0 group/name">
            <span 
              className={cn(
                "font-semibold tracking-tight truncate transition-colors cursor-text",
                isRunning ? "text-primary" : "text-foreground/90 group-hover/task:text-foreground"
              )}
          ...
          <AlertDialogContent className="bg-card border-white/5 backdrop-blur-xl">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-muted-foreground">
                This will permanently remove "{taskName}". This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
